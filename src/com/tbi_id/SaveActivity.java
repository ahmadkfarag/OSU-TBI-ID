...
public class SaveActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ImageButton saveYes = (ImageButton) findViewById(R.id.saveYes);
		final ImageButton saveNo = (ImageButton) findViewById(R.id.saveNo);
		...
		final String interview_time = stamp.toString();
		final String state = Environment.getExternalStorageState();
		final TextView saveShow = (TextView) findViewById(R.id.saveTitle);
		saveShow.setText("Do you want to save the file to your device?");
			...
			public void onClick(View arg0) {
				...
				if (Environment.MEDIA_MOUNTED.equals(state)) { 
					...
					final boolean didSave;
					 csv = new File(path, interview_name + interview_date + interview_time + "TBI_ID"
							+ ".csv");
						final String newPath = csv.getAbsolutePath();
						saveShow.setText("The report file has been saved to the device in the directory " + "TBI-ID " + "with the filename: " + interview_time +  "TBI_ID"+ ".csv \n\nPress \"Next\" to continue.");
						...
						try {
							...
							writer.flush();
							writer.close();
					        MediaScannerConnection.scanFile(context, new String[] { csv.getAbsolutePath() }, null, null);
					        didSave = true;
					        b.putString("timestamp", interview_time);
					        b.putBoolean("didSave", didSave);
					        b.putString("newPath", newPath);
					        saveYes.setVisibility(View.GONE);
							saveNo.setVisibility(View.GONE);
		...
		saveNo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				saveYes.setVisibility(View.GONE);
				saveNo.setVisibility(View.GONE);
				saveShow.setText("The report file was not saved, press the \"Next\" button to continue");
		        b.putString("timestamp", interview_time);
		...
		final ImageButton continueSend = (ImageButton) findViewById(R.id.continue_save_button);
		continueSend.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				Intent send = new Intent(getApplicationContext(), com.tbi_id.SendActivity.class);				
				send.putExtras(b);
				startActivity(send);
